...
public class TypeScriptOnlyClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public TypeScriptOnlyClientCodegen() {
        super();
        importMapping.clear();
        outputFolder = "generated-code/typescript-only";
    ...
    public String getHelp() {
        return "Generates a TypeScript only client library.";
    }
